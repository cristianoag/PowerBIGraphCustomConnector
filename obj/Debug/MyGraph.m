...
shared MyGraphImpl = (message as text) =>
     let
         //source = OData.Feed(message, null, [ ODataVersion = 4, MoreColumns = true ])
         source = Web.Contents(message)
     in
         source;

MyGraphType = type function (
    message as (type text meta [
        Documentation.FieldCaption = "Graph URL",
        Documentation.FieldDescription = "Graph URL to use",
        Documentation.SampleValues = {"https://graph.microsoft.com/v1.0/me", "https://graph.microsoft.com/beta/me"}
    ]))
    as table meta [
        Documentation.Name = "Microsoft Graph Connector",
        Documentation.LongDescription = "This is the Microsoft Graph Connector",
        Documentation.Examples = {[
            Description = "Returns a table with all Bookings appointments for a specific business",
            Code = "HelloWorldWithDocs.Contents(""https://graph.microsoft.com/beta/bookingBusinesses/TestHospital@M365x706011.onmicrosoft.com/appointments"")"
        ]}
    ];
